...
int main(void) {
    ...
    GeometricBrownianMotion gbm(timesteps, paths, spot, mu, sigma);
    const auto process = gbm.simulate(s, t);
    ...
    ax->xlabel("t");
    ax->ylabel("S(t)");
    ax->title("Geometric Brownian Motion");
    f->show();
